...
def now_local():
    # Always return correct Asia/Kolkata timezone datetime
...
def is_within_attendance_window(dt_local):
    t = dt_local.time()
    t = datetime.time(t.hour, t.minute, t.second)  # remove microseconds
